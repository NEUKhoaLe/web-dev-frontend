...
const MCQEditor = function (props: QuestionEditorTypesProps) {
   ...
   <div className={"d-flex flex-column"}>
     ...
     {!props.isValid &&
         <div className={"flex-row text-center mt-4"} style={{color: "red", fontWeight: "bold"}}>
             <p>Multiple Choice Questions have to only have 1 correct answer, and have more than one choice and more than 0 points.</p>
        </div>
     }
     <hr/>
   </div>
